...
with open(file=filename,mode='w',newline='',encoding='utf-8-sig') as file:
    ...
    for page in range(223,373):
        ...
        while(i<10):
            ...
            # a_selector = 'body > div.w-990 > div.main-content > div.shiti-content > div:nth-child(1) > ul > li:nth-child(1) > label'
            # b_selector = 'body > div.w-990 > div.main-content > div.shiti-content > div:nth-child(1) > ul > li:nth-child(2) > label'
            # c_selector = 'body > div.w-990 > div.main-content > div.shiti-content > div:nth-child(1) > ul > li:nth-child(3) > label'
            # d_selector = 'body > div.w-990 > div.main-content > div.shiti-content > div:nth-child(1) > ul > li:nth-child(4) > label'
